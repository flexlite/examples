package org.flexlite.test.skin
{
	 ...
	 * @author DXMLCompiler
	 */
	public class TitleWindowSkin extends org.flexlite.domUI.components.StateSkin
	{
		//==========================================================================
		//                                定义成员变量
		//==========================================================================
		...
		public function TitleWindowSkin()
		{
			...
			this.elementsContent = [__TitleWindowSkin_UIAsset1_i(),__TitleWindowSkin_UIAsset2_i(),closeButton_i(),confirmButton_i(),contentGroup_i(),titleDisplay_i(),moveArea_i()];
		...
		private function __TitleWindowSkin_UIAsset1_i():org.flexlite.domUI.components.UIAsset
		{
		...
		private function __TitleWindowSkin_UIAsset2_i():org.flexlite.domUI.components.UIAsset
		{
			var temp:org.flexlite.domUI.components.UIAsset = new org.flexlite.domUI.components.UIAsset();
			temp.bottom = 35;
			temp.left = 11;
