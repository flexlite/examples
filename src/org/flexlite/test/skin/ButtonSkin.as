package org.flexlite.test.skin
{
	...
	public class ButtonSkin extends SparkSkin
	{
		...
		//                                定义成员变量
		//==========================================================================
		public var _ButtonSkin_GradientEntry1:GradientEntry;

		public var _ButtonSkin_GradientEntry11:GradientEntry;

		public var _ButtonSkin_GradientEntry12:GradientEntry;

		public var _ButtonSkin_GradientEntry2:GradientEntry;

		public var _ButtonSkin_GradientEntry20:GradientEntry;

		public var _ButtonSkin_GradientEntry21:GradientEntry;

		public var _ButtonSkin_GradientEntry3:GradientEntry;

		public var _ButtonSkin_GradientEntry4:GradientEntry;

		public var _ButtonSkin_GradientEntry8:GradientEntry;

		public var _ButtonSkin_GradientEntry9:GradientEntry;
		...
		public function ButtonSkin()
		{
			...
			//绑定样式属性值
			bindStyle("color","color","_ButtonSkin_GradientEntry3");
			bindStyle("color2","color","_ButtonSkin_GradientEntry4");
		...
		{
			var temp:GradientEntry = new GradientEntry();
			_ButtonSkin_GradientEntry11 = temp;
			temp.color = 0xFFFFFF;
			return temp;
		}
		...
		{
			var temp:GradientEntry = new GradientEntry();
			_ButtonSkin_GradientEntry12 = temp;
			temp.color = 0xD8D8D8;
			return temp;
		}
		...
		{
			var temp:GradientEntry = new GradientEntry();
			_ButtonSkin_GradientEntry1 = temp;
			temp.color = 0x000000;
			temp.alpha = 0.01;
			return temp;
		}
		...
		{
			var temp:GradientEntry = new GradientEntry();
			_ButtonSkin_GradientEntry20 = temp;
			temp.color = 0x000000;
			temp.alpha = 0.5625;
			return temp;
		}
		...
		{
			var temp:GradientEntry = new GradientEntry();
			_ButtonSkin_GradientEntry21 = temp;
			temp.color = 0x000000;
			temp.alpha = 0.75;
			return temp;
		}
		...
		{
			var temp:GradientEntry = new GradientEntry();
			_ButtonSkin_GradientEntry2 = temp;
			temp.color = 0x000000;
			temp.alpha = 0.07;
			return temp;
		}
		...
		{
			var temp:GradientEntry = new GradientEntry();
			_ButtonSkin_GradientEntry3 = temp;
			temp.color = 0x009aff;
			temp.alpha = 0.85;
			return temp;
		}
		...
		{
			var temp:GradientEntry = new GradientEntry();
			_ButtonSkin_GradientEntry4 = temp;
			temp.color = 0x009aff;
			temp.alpha = 0.85;
			return temp;
		}
		...
		{
			var temp:GradientEntry = new GradientEntry();
			_ButtonSkin_GradientEntry8 = temp;
			temp.color = 0xFFFFFF;
			temp.ratio = 0.0;
			temp.alpha = 0.33;
			return temp;
		...
		{
			var temp:GradientEntry = new GradientEntry();
			_ButtonSkin_GradientEntry9 = temp;
			temp.color = 0xFFFFFF;
			temp.ratio = 0.48;
			temp.alpha = 0.33;
			return temp;
